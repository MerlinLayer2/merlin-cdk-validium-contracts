...
async function buildMultiSigBodyWithBody(wallet: any){
    ...
    const timeLockData = contractInterface2.encodeFunctionData(
        "schedule",
        [
            fork12configPath.polygonRollupManagerAddress, 0, addRollupData, ethers.ZeroHash, fork12configPath.salt, fork12configPath.timelock_delay
        ]
    );
