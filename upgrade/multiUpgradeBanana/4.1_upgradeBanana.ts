...
const upgradeParameters = require("./merlin-upgrade-fork12.json");
...
async function main() {
    ...
    const rollupManagerAddress = upgradeParameters.polygonRollupManagerAddress;
    const timelockDelay = upgradeParameters.timelock_delay
    const salt = upgradeParameters.salt || ethers.ZeroHash;
    ...
    const adm = await upgrades.erc1967.getAdminAddress(rollupManagerAddress as string)
    console.log("proxyAdmin getAdminAddress: ", adm);
